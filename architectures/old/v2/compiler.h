...
map<string, uint8_t> opcode_map = {
    {"nop", 0b00000000},   {"mov", 0b00000000},   {"imm1l", 0b01000000},
    {"imm1h", 0b01010000}, {"imm2l", 0b01100000}, {"imm2h", 0b01110000},
    {"st", 0b10000000},    {"ld", 0b10001000},    {"add", 0b10010000},
    {"sub", 0b10011000},   {"and", 0b10100000},   {"or", 0b10101000},
    {"xor", 0b10110000},   {"shr", 0b10111000},   {"jz", 0b11000001},
    {"jn", 0b11001001},    {"jc", 0b11010001},    {"jmp", 0b11011001},
    {"jnz", 0b11100001},   {"jnn", 0b11101001},   {"jnc", 0b11110001},
    {"call", 0b11111001},  {"ret", 0b11111000},   {"halt", 0b11111111}};
...
vector<uint8_t> compileAssembly(string &programString) {
    ...
    for (vector<string> &line : tokens) {
        ...
        } else if (opcode == "imm1l" || opcode == "imm1h" ||
                   opcode == "imm2l" || opcode == "imm2h") {
            instruction |= stringToInteger(line[1]);
        } else if (opcode == "add" || opcode == "sub" || opcode == "and" ||
                   opcode == "or" || opcode == "xor" || opcode == "st" ||
                   opcode == "ld") {
